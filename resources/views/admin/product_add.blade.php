...
<form action="" method="post" class="form form-horizontal" id="form-product-add">
  ...
  <div class="row cl">
    ...
    <div class="formControls col-5">
      <img id="preview_id" src="/dashboard/laravel52/public/admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id').click()" />
  ...
  <div class="row cl">
    ...
    <div class="formControls col-8">
      <img id="preview_id1" src="/dashboard/laravel52/public/admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id1').click()" />
      ...
      <img id="preview_id2" src="/dashboard/laravel52/public/admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id2').click()" />
      ...
      <img id="preview_id3" src="/dashboard/laravel52/public/admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id3').click()" />
      ...
      <img id="preview_id4" src="/dashboard/laravel52/public/admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id4').click()" />
      ...
      <img id="preview_id5" src="/dashboard/laravel52/public/admin/images/icon-add.png" style="border: 1px solid #B8B9B9; width: 100px; height: 100px;" onclick="$('#input_id5').click()" />
  ...
  $("#form-product-add").Validform({
    ...
    callback:function(form){
      $('#form-product-add').ajaxSubmit({
          ...
          url: '/dashboard/laravel52/public/admin/service/product/add', // 需要提交的 url
          dataType: 'json',
          data: {
            ...
            preview1: ($('#preview_id1').attr('src')!='/dashboard/laravel52/public/admin/images/icon-add.png'?$('#preview_id1').attr('src'):''),
            preview2: ($('#preview_id2').attr('src')!='/dashboard/laravel52/public/admin/images/icon-add.png'?$('#preview_id2').attr('src'):''),
            preview3: ($('#preview_id3').attr('src')!='/dashboard/laravel52/public/admin/images/icon-add.png'?$('#preview_id3').attr('src'):''),
            preview4: ($('#preview_id4').attr('src')!='/dashboard/laravel52/public/admin/images/icon-add.png'?$('#preview_id4').attr('src'):''),
            preview5: ($('#preview_id5').attr('src')!='/dashboard/laravel52/public/admin/images/icon-add.png'?$('#preview_id5').attr('src'):''),
            _token: "{{csrf_token()}}"
          },
